    ...
    return (
        <div>
            ...
            <div class="grid bg-white rounded-lg shadow-xl w-11/12 md:w-9/12 lg:w-1/2">
                ...
                <label class="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold">Room Name</label>
                <input class="py-2 px-3 rounded-lg border-2 border-purple-300 mt-1 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent" type="text" placeholder="Room Name" />
                </div>
